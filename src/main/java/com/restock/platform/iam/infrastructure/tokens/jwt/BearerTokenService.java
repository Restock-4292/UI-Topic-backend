package com.restock.platform.iam.infrastructure.tokens.jwt;
 ...
 * This interface is used to inject the JWT token service in the {@link com.acme.center.platform.iam.infrastructure.tokens.jwt.services.TokenServiceImpl} class.
 */
